...
class MealService {
  static const ADD_URL = "http://nc.nuraycelik.com/mymeals/add.php";
  static const VIEW_URL =
      "http://nc.nuraycelik.com/contentmeals/contentviews.php";
  static const GETID_URL =
      "http://nc.nuraycelik.com/contentmeals/selectcatId.php";
  static const UPDATE_URL = "http://nc.nuraycelik.com/mymeals/update.php";
  static const DELETE_URL =
      "http://nc.nuraycelik.com/contentmeals/selectdelete.php";
 ...
 Future<List> getMealsId(String mealId) async {
    final response = await http.post(
      "http://nc.nuraycelik.com/contentmeals/selectmealId.php",
      body: <String, String>{
        "id": mealId,
      },
    );
  ...
  Future<String> updateMealsFavorite(String mealId, String isFavorite) async {
    final response = await http.post("http://nc.nuraycelik.com/contentmeals/mealschange.php", body: <String, String>{
        "id": mealId,
