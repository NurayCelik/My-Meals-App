...
class LocalDeneme extends StatefulWidget {
  LocalDeneme({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LocalDenemeState createState() => _LocalDenemeState();
}

class _LocalDenemeState extends State<LocalDeneme> {
